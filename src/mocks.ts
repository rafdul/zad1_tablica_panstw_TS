...
export const mockValues: Values = {
    ...
    states2: [{id: 1, alpha3Code: 'MON', name: 'Monaco', population: 800000, regionalBlocs: [{acronym: 'XX'}]}, {id: 2, alpha3Code: 'SAN', name: 'San Marino', population: 49000, regionalBlocs: [{acronym: 'XX'}]}, {id: 2, alpha3Code: 'BOS', name: 'Bostwana', population: 5000000, regionalBlocs: [{acronym: 'XX'}]}, {id: 3, alpha3Code: 'KEN', name: 'Kenia', population: 50000000, regionalBlocs: [{acronym: 'XX'}]}],
    ...
    statesWithPopulation: [{name: "Czech Republic", population: 10698896, area: 78865, density: 135.66, regionalBlocs: [{acronym: 'EU'}]}, {name: "Sweden", population: 10353442, area: 450295, density: 22.99, regionalBlocs: [{acronym: 'EU'}]}, {name: "Netherlands", population: 17441139, area: 41850, density: 416.75, regionalBlocs: [{acronym: 'EU'}]}, {name: "Poland", population: 37950802, area: 312679, density: 121.37, regionalBlocs: [{acronym: 'EU'}]}],
