...
export const mockValues: Values = {
    ...
    statesForNewObj: [
        ...
        {name: "Czech Republic", alpha3Code: 'CZR', nativeName: 'czechsssss', languages:[{iso639_1: 'cs', iso639_2: 'ces', name: 'Czech', nativeName: 'čeština'}, {iso639_1: 'sk', iso639_2: 'slk', name: 'Slovak', nativeName: 'slovenčina'}], currencies: [{code: 'CZK', name: 'Czech koruna', symbol: 'Kč'}], population: 10698896, area: 78865, regionalBlocs: [{acronym: 'EU'}]},
        {name: "Kongo", alpha3Code: 'KON', nativeName: 'kongossssss', languages:[{iso639_1: 'fr', iso639_2: 'fra', name: 'French', nativeName: 'français'}, {iso639_1: 'ln', iso639_2: 'lin', name: 'Lingala', nativeName: 'Lingála'}], currencies: [{code: 'XAF', name: 'Central African CFA franc', symbol: 'Fr'}], population: 95623139, area: 41850, regionalBlocs: [{acronym: 'AU'}]},
        {name: "Iran", alpha3Code: 'IRN', nativeName: 'iransssss', languages:[{iso639_1: 'fa', iso639_2: 'fas', name: 'Persian (Farsi)', nativeName: 'فارسی'}, {iso639_1: 'fr', iso639_2: 'fra', name: 'French', nativeName: 'français'}], currencies: [{code: 'IRR', name: 'Iranian rial', symbol: '﷼'}], population: 44698896, area: 48865, regionalBlocs: [{acronym: 'AU'}]},
        ...
        {name: "Mexico", alpha3Code: 'MEX', nativeName: 'meksyksssss', languages:[{iso639_1: 'fr', iso639_2: 'fra', name: 'French', nativeName: 'français'}, {iso639_1: 'es', iso639_2: 'spa', name: 'Spanish', nativeName: 'Español'}], currencies: [{code: 'MXN', name: 'Mexican peso', symbol: '$'}], population: 94698896, area: 99865, regionalBlocs: [{acronym: 'NAFTA'}]},
