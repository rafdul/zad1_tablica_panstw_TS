...
export const mockValues: Values = {
    ...
    statesForNewObj: [
        {name: "Netherlands", nativeName: 'netherlandsssss', currencies: [{code: 'EUR', name: 'Euro', symbol: '€'}], population: 17441139, area: 41850, regionalBlocs: [{acronym: 'EU'}]},
        {name: "Czech Republic", nativeName: 'czechsssss', currencies: [{code: 'CZK', name: 'Czech koruna', symbol: 'Kč'}], population: 10698896, area: 78865, regionalBlocs: [{acronym: 'EU'}]},
        {name: "Kongo", nativeName: 'kongossssss', currencies: [{code: 'XAF', name: 'Central African CFA franc', symbol: 'Fr'}], population: 95623139, area: 41850, regionalBlocs: [{acronym: 'AU'}]},
        {name: "Iran", nativeName: 'iransssss', currencies: [{code: 'IRR', name: 'Iranian rial', symbol: '﷼'}], population: 44698896, area: 48865, regionalBlocs: [{acronym: 'AU'}]},
        {name: "Canada", nativeName: 'kanadassssss', currencies: [{code: 'CAD', name: 'Canadian dollar', symbol: '$'}], population: 37623139, area: 105850, regionalBlocs: [{acronym: 'NAFTA'}]},
        {name: "Mexico", nativeName: 'meksyksssss', currencies: [{code: 'MXN', name: 'Mexican peso', symbol: '$'}], population: 94698896, area: 99865, regionalBlocs: [{acronym: 'NAFTA'}]},
        {name: "China", nativeName: 'chinasssss', currencies: [{code: 'CNY', name: 'Chinese yuan', symbol: '¥'}], population: 1123698896, area: 206865, regionalBlocs: [{acronym: 'ASEAN'}]},
        {name: "Peru", nativeName: 'perussssss', currencies: [{code: 'CNY', name: 'Chinese yuan', symbol: '¥'}], population: 29562321, area: 88865},
    ],
